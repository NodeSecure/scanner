...
describe("scanJavascriptFile", () => {
  it("scanJavascriptFile (fixture one.js)", async() => {
  ...
  it("scanJavascriptFile (fixture two.min.js)", async() => {
  ...
  it("scanJavascriptFile (fixture onelineStmt.min.js)", async() => {
  ...
  it("scanJavascriptFile (fixture parsingError.js)", async() => {
