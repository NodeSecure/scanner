...
describe("analyzeDependencies", () => {
  it("analyzeDependencies should detect Node.js dependencies and also flag hasExternalCapacity", () => {
    const packageDeps = [];
  ...
  it("analyzeDependencies should detect prefixed (namespaced 'node:') core dependencies", () => {
  ...
  it("analyzeDependencies should be capable of detecting unused dependency 'koa'", () => {
  ...
  it("analyzeDependencies should be capable of detecting unused dependency 'kleur'", () => {
  ...
  it("analyzeDependencies should ignore '@types' for third-party dependencies", () => {
  ...
  it("analyzeDependencies should ignore file dependencies and try dependencies", () => {
    const packageDeps = [];
    const packageDevDeps = ["kleur"];
  ...
  it("analyzeDependencies should detect Node.js subpath import and set relation between #dep and kleur.", () => {
  ...
  it("analyzeDependencies should detect Node.js subpath import (with a default property pointing to a file)", () => {
    const packageDeps = ["kleur"];
    const packageDevDeps = [];
    const nodeImports = {
      "#dep": {
