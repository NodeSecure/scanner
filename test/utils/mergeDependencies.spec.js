...
describe("mergeDependencies", () => {
  it("should return the one.json field 'dependencies' merged", () => {
  ...
  it("should return the one.json field 'dependencies' & 'devDependencies' merged", () => {
  ...
  it("should return two.json 'dependencies' & 'devDependencies' merged (with a custom Resolvers)", () => {
  ...
  it("should return no dependencies/customResolvers for three.json", () => {
  ...
  it("should detect NPM alias using custom resolvers npm: (but still count it as normal dependency)", () => {
