...
export async function scanPackage(
  ...
  const mama = await (typeof manifestOrLocation === "string" ?
    ManifestManager.fromPackageJSON(manifestOrLocation) :
    Promise.resolve(manifestOrLocation));
...
export async function extractAndResolve(
  ...
  // FIX: bug here if package.json is omitted
